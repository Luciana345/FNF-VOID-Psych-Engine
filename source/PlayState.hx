...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		var doofVoid:VoidDialogueBox = new VoidDialogueBox(false, dialogue);
		doofVoid.scrollFactor.set();
		doofVoid.finishThing = startCountdown;
	...
	function spaceIntro(?dialogueBox:VoidDialogueBox):Void
	{
	...
	public function endSong():Void
	{
		...
		var achieve:String = checkForAchievement(['void1_nomiss', 'void2_nomiss', 'security_fc']);
		if(achieve != null) {
	...
	private function checkForAchievement(achievesToCheck:Array<String> = null):String
	{
		...
		for (i in 0...achievesToCheck.length) {
			...
			if(!Achievements.isAchievementUnlocked(achievementName) && !cpuControlled) {
				...
				{
					case 'void1_nomiss' | 'week2_nomiss':
						if(isStoryMode && campaignMisses + songMisses < 1 && CoolUtil.difficultyString() == 'HARD' && storyPlaylist.length <= 1 && !changedDifficulty && !usedPractice)
						{
							...
							{
								case 'void1':
									if(achievementName == 'void1_nomiss') unlock = true;
								case 'void2':
									if(achievementName == 'void2_nomiss') unlock = true;
							}
						}

					case 'security_fc':
						if(Paths.formatToSongPath(SONG.song) == 'security' && campaignMisses + songMisses < 1 && CoolUtil.difficultyString() == 'HARD' && !usedPractice) {
							unlock = true;
						}
				}
